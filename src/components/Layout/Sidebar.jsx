    ...
    >
      ...
      <Collapse in={openProjects} timeout="auto" unmountOnExit>
        <List component="div" disablePadding>
          ...
          <ListItem
            button
            onClick={() => redirectTo("/nuevo-proyecto")}
            className={classes.nested}
          >
            <ListItemIcon>
      ...
      <Collapse in={openEmployees} timeout="auto" unmountOnExit>
        <List component="div" disablePadding>
          ...
          <ListItem
            button
            onClick={() => redirectTo("/nuevo-empleado")}
            className={classes.nested}
          >
            <ListItemIcon>
              <AddCircleIcon fontSize="small" />
      ...
      <Collapse in={openClients} timeout="auto" unmountOnExit>
        <List component="div" disablePadding>
          ...
          <ListItem
            button
            onClick={() => redirectTo("/nuevo-cliente")}
            className={classes.nested}
          >
            <ListItemIcon>
              <AddCircleIcon fontSize="small" />
